"""
seed_all_products.py — Seed all 20 products with real Cloudinary URLs
"""
import httpx
import asyncio
import os
...
# All 20 products with Cloudinary URLs
ALL_PRODUCTS = [
    {
        "sku": "TOP-003",
    ...
    },
    {
        ...
        "Description": "Built for the commute and the conference room. Technical fabric moves with you, resists wrinkles, and keeps you cool.",
        "category": "T-Shirts",
        "brand": "UrbanThread",
        "price": 54.99,
        "status": "active",
        "tags": ["polo", "performance", "workwear"],
        "cloudinary_url": "https://res.cloudinary.com/dp0cdq8bj/image/upload/v1774234835/TOP-004_pu7ydv.jpg",
        "cloudinary_public_id": "TOP-004_pu7ydv",
    ...
    },
    {
        ...
        "Description": "The weekday warrior. Stretch cotton blend moves with you through commutes, meetings, and after-work drinks.",
        "category": "Bottoms",
        "brand": "UrbanThread",
        "price": 69.99,
        "status": "active",
        "tags": ["chino", "stretch", "workwear", "straight-fit"],
        "cloudinary_url": "https://res.cloudinary.com/dp0cdq8bj/image/upload/v1774238034/DNM-003_addc2l.jpg",
        "cloudinary_public_id": "DNM-003_addc2l",
        "target_segment": "Everyday Basics"
    },
    {
        "sku": "DNM-004",
        ...
        for product in ALL_PRODUCTS:
            ...
            try:
                ...
                if response.status_code in [200, 201]:
                    ...
                    print(f"⚠️  Failed {product['sku']}: {response.status_code} - {response.text[:100]}")
            except Exception as e:
                print(f"❌ Error {product['sku']}: {str(e)[:100]}")
        
        print(f"\n🎉 Complete! Created {created}, Skipped {skipped}, Total: {created + skipped}/20")

if __name__ == "__main__":
    print("🚀 Seeding all 20 products to Directus with Cloudinary images...\n")
