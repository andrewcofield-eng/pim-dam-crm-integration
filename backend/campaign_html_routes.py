...
async def generate_copy_with_ai(req: CampaignRequest, products: list) -> dict:
    ...
    body = ("Hi " + first + ", we curated our best pieces for " + company +
            ". Premium quality, custom logos available, 48h turnaround.")
    lp_b = ("Explore the full collection built for " + company +
            ". Every piece is premium quality with custom branding available.")
